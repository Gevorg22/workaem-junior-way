...
/**
 * Оформление уровня. Подземелье - это не только другая палитра:
 * там есть потолок, нет неба и холмов, и от этого меняется ощущение
 * тесноты. Ради одного цвета отдельную тему заводить было бы незачем.
 */
export type Theme = "surface" | "underground";
