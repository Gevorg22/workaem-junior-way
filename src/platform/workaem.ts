...
/**
 * Работает ли вход на стороне workaem. Это же и выключатель: если сайт
 * или общий секрет отвалятся, ставим false - и игра перестаёт предлагать
 * вход, а не ведёт человека в никуда.
 */
